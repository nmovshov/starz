...
species would be
\begin{equation}\label{eq:partial_density}
...
\subsection{The adiabatic exponent}
\begin{itemize}
\item In \emph{adiabatic} processes
\begin{equation}
P\propto\rho^{\gamma\sub{a}}.
\end{equation}

\item The value of $\gamma\sb{a}$ is 5/3 in the case of simple gas or
non-relativistic completely degenerate electron gas, and 4/5 in the case of
relativistic degenerate gas or of pure radiation.
\end{itemize}
